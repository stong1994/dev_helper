...
// EnterColumnDataType is called when production columnDataType is entered.
func (s *BaseMySqlParserListener) EnterColumnDataType(ctx *ColumnDataTypeContext) {}

// ExitColumnDataType is called when production columnDataType is exited.
func (s *BaseMySqlParserListener) ExitColumnDataType(ctx *ColumnDataTypeContext) {}
