...
type MySqlParserListener interface {
	...
	// EnterColumnDataType is called when entering the columnDataType production.
	EnterColumnDataType(c *ColumnDataTypeContext)
	...
	// ExitColumnDataType is called when exiting the columnDataType production.
	ExitColumnDataType(c *ColumnDataTypeContext)
